"""Тесты классификатора коронарных артерий.

Проверяет:
- Работу с пустым списком файлов
- Классификацию с моками модели и DICOM
- Пороговую маршрутизацию: ≤0.10 → левая, ≥0.90 → правая, иначе серая зона
"""
import pytest
import numpy as np
